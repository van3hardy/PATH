...
## [1.23.0](https://github.com/greyson3hardy/PATH/compare/career-ops-v1.22.0...career-ops-v1.23.0) (2026-08-22)


### Features

* add dry-run Path dispatch stub ([bebc3c0](https://github.com/greyson3hardy/PATH/commit/bebc3c0226381a7019b1313f97cc6a38eec91781))
...
* add interview skill modes — plan, practice, debrief ([#956](https://github.com/greyson3hardy/PATH/issues/956)) ([e17a829](https://github.com/greyson3hardy/PATH/commit/e17a829b0a69262fcf3eacab01791aadf1e42154))
* add Path approval packets and audit ledger ([4d72f12](https://github.com/greyson3hardy/PATH/commit/4d72f1262a12510fcb33c5231b0f0d4af6ba31b9))
* add Path autonomy policy ([49c7d87](https://github.com/greyson3hardy/PATH/commit/49c7d8720428d4d5b1123811a913e98600ede3a6))
* add Path fact resolver ([3ede34a](https://github.com/greyson3hardy/PATH/commit/3ede34a639e617cb1135c13991b5015649e4f17a))
* add the opt-in experimental web UI surface (web/) — isolated versioning, CI and packaging ([432c3c5](https://github.com/greyson3hardy/PATH/commit/432c3c523a13bf0a5053b5d1f3c28c17ef1296eb))
* **add:** /career-ops add — fetch a project/paper/role into cv.md and article-digest.md ([#1476](https://github.com/greyson3hardy/PATH/issues/1476)) ([933c353](https://github.com/greyson3hardy/PATH/commit/933c3536959f29534769fcb92af37c3a60551475))
* **agent-inbox:** queue requests for the next session ([#1472](https://github.com/greyson3hardy/PATH/issues/1472)) ([182554d](https://github.com/greyson3hardy/PATH/commit/182554d1401f0be91b8474df9918dfaf5491c684))
...
* **apply:** ATS auto-fill for Greenhouse / Ashby / Lever — prepare, don't submit ([#1248](https://github.com/greyson3hardy/PATH/issues/1248)) ([215e6d1](https://github.com/greyson3hardy/PATH/commit/215e6d12f51e3f677c834ee81494320cf887a570))
* **apply:** pre-scan forms for knock-out questions before drafting ([#1463](https://github.com/greyson3hardy/PATH/issues/1463)) ([05a85b8](https://github.com/greyson3hardy/PATH/commit/05a85b8bb1b32991a6bed16c19080e47f19a414b))
* **apply:** warn before reapplying to a repeat company ([#1921](https://github.com/greyson3hardy/PATH/issues/1921)) ([6cdca85](https://github.com/greyson3hardy/PATH/commit/6cdca856bfeb6017abbb826afeb0f7282d9dc6f9)), closes [#1920](https://github.com/greyson3hardy/PATH/issues/1920)
* **batch:** apply compensation reliability checks to batch workers ([#1588](https://github.com/greyson3hardy/PATH/issues/1588)) ([d6cbb2a](https://github.com/greyson3hardy/PATH/commit/d6cbb2a126ef3e9361cb8ff331413df7db8ebd58))
* **browser-extract:** configurable jd-mode text cap via --max-chars ([#1810](https://github.com/greyson3hardy/PATH/issues/1810)) ([7b13dc9](https://github.com/greyson3hardy/PATH/commit/7b13dc9fc0fa5aaf5e8086fa38fd72c629fde080))
* **calibration:** funnel-velocity.mjs — own funnel vs market benchmarks ([#1693](https://github.com/greyson3hardy/PATH/issues/1693), part 1) ([#1694](https://github.com/greyson3hardy/PATH/issues/1694)) ([ff6a022](https://github.com/greyson3hardy/PATH/commit/ff6a02258a25a8b7f6105a5c2104f9baf6acdf70))
* classify application replies and generate review digest ([#1620](https://github.com/greyson3hardy/PATH/issues/1620)) ([f33f9e7](https://github.com/greyson3hardy/PATH/commit/f33f9e74a5bffcefe7c1433730f1275f3d71060e)), closes [#1585](https://github.com/greyson3hardy/PATH/issues/1585)
* **contacto:** short-greeting variant for chat-style outreach ([#1477](https://github.com/greyson3hardy/PATH/issues/1477)) ([8cf19a7](https://github.com/greyson3hardy/PATH/commit/8cf19a76ad381eeebfb7d35abd9d282006c24214))
* **contacts:** add append-only email-keyed people ledger module ([10e91f7](https://github.com/greyson3hardy/PATH/commit/10e91f7fcb0a139fb64a97838d46ee37f54ba953))
* **contacts:** add one-time idempotent backfill from tracker and outbox ([725d921](https://github.com/greyson3hardy/PATH/commit/725d921f1348de8de2f3039c8517df427f717d78))
* **contacts:** channel-scoped dedup — block re-outreach only on the intended channel ([468904c](https://github.com/greyson3hardy/PATH/commit/468904cb105b810d33943e0ee9481b59c028e2f2))
* **contacts:** name-only dedup — record and gate contacts with no email yet ([902dcc4](https://github.com/greyson3hardy/PATH/commit/902dcc41ec5c90203957d3ff72336c3f7b3ef5a3))
* **cover-letter:** support --format and --report CLI arguments ([#1830](https://github.com/greyson3hardy/PATH/issues/1830)) ([88c75cf](https://github.com/greyson3hardy/PATH/commit/88c75cf47a35ea9c41ed803d89f1d288989f2699)), closes [#1828](https://github.com/greyson3hardy/PATH/issues/1828)
* **cv:** Chinese minimal CV template ([#1990](https://github.com/greyson3hardy/PATH/issues/1990)) ([7cefd61](https://github.com/greyson3hardy/PATH/commit/7cefd616da4700984982b325d9fa817cf5c1eee9))
* **cv:** fact validator — block invented metrics in generated CVs ([#682](https://github.com/greyson3hardy/PATH/issues/682)) ([b9decee](https://github.com/greyson3hardy/PATH/commit/b9decee90eb00140b89912681deb34d7ecf48f94))
* **cv:** improve profile-photo configuration and preview ([#1991](https://github.com/greyson3hardy/PATH/issues/1991)) ([7e90f46](https://github.com/greyson3hardy/PATH/commit/7e90f46c1ce9cbb1bdcf679d6d5b249c0f3eaaa0))
* **dashboard:** add Spanish (es) locale to the i18n catalog ([#1783](https://github.com/greyson3hardy/PATH/issues/1783)) ([2ddb9ce](https://github.com/greyson3hardy/PATH/commit/2ddb9ce548667a0a8adb68e2bdac098d3b3310ff)), closes [#1764](https://github.com/greyson3hardy/PATH/issues/1764)
* **dashboard:** discard reason picker with learning loop ([#1465](https://github.com/greyson3hardy/PATH/issues/1465)) ([7845b11](https://github.com/greyson3hardy/PATH/commit/7845b11efc8d3dc58f1978096e6d4cd7c1cbc650)), closes [#1380](https://github.com/greyson3hardy/PATH/issues/1380)
* **dashboard:** Hired canonical status + job-landed celebration flow ([58736bc](https://github.com/greyson3hardy/PATH/commit/58736bc9b2a643f25f72758bc10c4d7ca45be651))
* **dashboard:** i18n extraction for the Go TUI (split from [#1666](https://github.com/greyson3hardy/PATH/issues/1666)) ([#1672](https://github.com/greyson3hardy/PATH/issues/1672)) ([3b5ef4f](https://github.com/greyson3hardy/PATH/commit/3b5ef4f1052ae2029a2b3f0a024a57809ac36189))
* **dashboard:** manifesto shortcut, help entry and footer link ([64e81de](https://github.com/greyson3hardy/PATH/commit/64e81dee1ee0be48475d32248b26d928089f5d50))
* **discovery:** seed company universe from VC portfolios (YC / a16z)… ([#1375](https://github.com/greyson3hardy/PATH/issues/1375)) ([9a816f5](https://github.com/greyson3hardy/PATH/commit/9a816f5488e9bfbee616b51f7121441ed2be07c3))
* **email:** add confirmed-time no-show follow-up variant ([#1860](https://github.com/greyson3hardy/PATH/issues/1860)) ([c77d138](https://github.com/greyson3hardy/PATH/commit/c77d138faf84e22422d8cb80195d8b4f524eff23)), closes [#1859](https://github.com/greyson3hardy/PATH/issues/1859)
* **email:** ATS-broken fallback scenario — recover a stuck application ([#1741](https://github.com/greyson3hardy/PATH/issues/1741)) ([#1745](https://github.com/greyson3hardy/PATH/issues/1745)) ([4caabf0](https://github.com/greyson3hardy/PATH/commit/4caabf04cf68036039b2112177ca95a4e06aa6f9))
* **email:** formal application email drafts — draft-only, never sends ([#1515](https://github.com/greyson3hardy/PATH/issues/1515)) ([f7dfb88](https://github.com/greyson3hardy/PATH/commit/f7dfb88f4d18a598db3d1d327648194d98807ef9))
* **expand:** add /expand mode to discover missing CV competencies ([#1533](https://github.com/greyson3hardy/PATH/issues/1533)) ([1ea5ee6](https://github.com/greyson3hardy/PATH/commit/1ea5ee6379a90dfb1bec17b01aa538a624953848)), closes [#1521](https://github.com/greyson3hardy/PATH/issues/1521)
...
* **find:** resolve a company/role/number query to its full pipeline identity ([#1439](https://github.com/greyson3hardy/PATH/issues/1439)) ([3fd0a06](https://github.com/greyson3hardy/PATH/commit/3fd0a06c14481633d28db5a47f9c9317205e9a7d))
* **followup:** seed a pinned first follow-up when a row turns Applied ([#1468](https://github.com/greyson3hardy/PATH/issues/1468)) ([ea6f608](https://github.com/greyson3hardy/PATH/commit/ea6f6086696c68d5437cf6c5007c4a90b161b011))
* gate dry-run dispatch on approval ([2da9597](https://github.com/greyson3hardy/PATH/commit/2da95974fcbc00e326ad90a7f58f139138cdf652))
* gate outbound actions behind approvals ([12c3364](https://github.com/greyson3hardy/PATH/commit/12c336490a357eec83eb4445bfb81247cb570d93))
* **gemini-eval:** static prefix as systemInstruction for implicit caching ([#1840](https://github.com/greyson3hardy/PATH/issues/1840)) ([bb748d8](https://github.com/greyson3hardy/PATH/commit/bb748d8c6064127ca4ce23b55d59f58984fac2d2))
* **gmail-replies:** CLI — args, env, config, file writes, dry-run ([771812b](https://github.com/greyson3hardy/PATH/commit/771812b112eb6497ab81a22a445f3d65c9bdfb10))
* **gmail-replies:** OAuth token exchange + Gmail list/detail fetch helpers ([930b98f](https://github.com/greyson3hardy/PATH/commit/930b98fa6f599a14d3bebc173f3d93e934389102))
* **gmail-replies:** pure helpers — list query, blocklist, message parsing ([be16922](https://github.com/greyson3hardy/PATH/commit/be16922cc59df5ad8ac0206ea87c3057a424834b))
* **gmail-replies:** scanReplies orchestrator with injectable write seam ([e283504](https://github.com/greyson3hardy/PATH/commit/e28350490bc71d1669523b783a4a8a0c6d31e644))
* **gmail-send:** add pure fetch transport with unit tests ([0fa661c](https://github.com/greyson3hardy/PATH/commit/0fa661c2306c95dc8bdeeb9c391fc0d535758e4e))
* harden dry-run dispatch checks ([633cd3e](https://github.com/greyson3hardy/PATH/commit/633cd3e8828ce4fef24d6338a3bc12011311fcec))
* **i18n:** add German translations of interview modes ([#1610](https://github.com/greyson3hardy/PATH/issues/1610)) ([a6b6180](https://github.com/greyson3hardy/PATH/commit/a6b618012045fc543e3ced0db10bb1ad37cd75f9))
* **i18n:** add Hindi language support with dedicated modes and documentation ([7463d75](https://github.com/greyson3hardy/PATH/commit/7463d75013149c745f204c21c7823ded4e3f416a))
* **i18n:** add Indonesian (id) modes ([#1474](https://github.com/greyson3hardy/PATH/issues/1474)) ([6262d53](https://github.com/greyson3hardy/PATH/commit/6262d532494e01964c99a30c8ea1347bcd9de730))
* **i18n:** add Korean career-ops modes ([#1457](https://github.com/greyson3hardy/PATH/issues/1457)) ([ced5f74](https://github.com/greyson3hardy/PATH/commit/ced5f74b0eadde187e7de76e70f9ab1ce7918d64))
* **i18n:** add Traditional Chinese (zh-TW) modes ([#1371](https://github.com/greyson3hardy/PATH/issues/1371)) ([#1760](https://github.com/greyson3hardy/PATH/issues/1760)) ([d9c338d](https://github.com/greyson3hardy/PATH/commit/d9c338db88b868bb63549f2c998ae2dbb5d71ad7))
* **i18n:** Chinese salary reliability checks — zh mirror of the compensation tiers ([#1589](https://github.com/greyson3hardy/PATH/issues/1589)) ([5771478](https://github.com/greyson3hardy/PATH/commit/5771478c808435fff1ec0666bc0245dc7213d162))
* **i18n:** Simplified Chinese interview modes (plan/practice/debrief) ([#1977](https://github.com/greyson3hardy/PATH/issues/1977)) ([1634f01](https://github.com/greyson3hardy/PATH/commit/1634f0163a666da438c0b828b7efbbca38d3a3b5))
* **i18n:** translate interview modes to French ([#1526](https://github.com/greyson3hardy/PATH/issues/1526)) ([53f77a0](https://github.com/greyson3hardy/PATH/commit/53f77a09000c3437285a77d3ad86e5e1c619a596)), closes [#1489](https://github.com/greyson3hardy/PATH/issues/1489)
* **i18n:** translate interview modes to Spanish ([#1523](https://github.com/greyson3hardy/PATH/issues/1523)) ([3657bf0](https://github.com/greyson3hardy/PATH/commit/3657bf0e8eb0cb2dc922ad43a94c7365c54250dc)), closes [#1490](https://github.com/greyson3hardy/PATH/issues/1490)
* **img-to-pdf:** convert a screenshot into a PDF for ATS uploads ([#1730](https://github.com/greyson3hardy/PATH/issues/1730)) ([#1731](https://github.com/greyson3hardy/PATH/issues/1731)) ([6b3b4e8](https://github.com/greyson3hardy/PATH/commit/6b3b4e824c480e8d1e3204c4a5a34c75d114e9f0))
* **interview-prep:** cross-reference coffee chat notes against interview intel ([#1941](https://github.com/greyson3hardy/PATH/issues/1941)) ([2692051](https://github.com/greyson3hardy/PATH/commit/269205162c4af846ca216b611b32d71ff920e012)), closes [#1940](https://github.com/greyson3hardy/PATH/issues/1940)
* **interview-prep:** structured Panel Intel table ([#1502](https://github.com/greyson3hardy/PATH/issues/1502)) ([72b1d5e](https://github.com/greyson3hardy/PATH/commit/72b1d5e8c442288b59c6455ce2eb25b99b283b4d))
* **interview-prep:** URL entry path for a role that was never evaluated ([#1817](https://github.com/greyson3hardy/PATH/issues/1817)) ([b9b54b8](https://github.com/greyson3hardy/PATH/commit/b9b54b8205515e66a41dc3461381dc895f4d9b2f)), closes [#1816](https://github.com/greyson3hardy/PATH/issues/1816)
* **interview-redflag:** flag scope/compensation mismatch as a separate fifth dimension ([#1943](https://github.com/greyson3hardy/PATH/issues/1943)) ([ea57b82](https://github.com/greyson3hardy/PATH/commit/ea57b82652cd7b261935f80001c80b3984843e0f)), closes [#1942](https://github.com/greyson3hardy/PATH/issues/1942)
* **interview-redflag:** suggest a ready-to-copy blacklist row at Reconsider level ([#1856](https://github.com/greyson3hardy/PATH/issues/1856)) ([b645e69](https://github.com/greyson3hardy/PATH/commit/b645e69ab96af5fe5483938da390108bfd816070)), closes [#1854](https://github.com/greyson3hardy/PATH/issues/1854)
* **interview/plan:** wire the existing Panel Intel table into multi-panelist rounds ([#1858](https://github.com/greyson3hardy/PATH/issues/1858)) ([a8ceed2](https://github.com/greyson3hardy/PATH/commit/a8ceed2b79c102cc33c0309f7201b385ec8ab091)), closes [#1857](https://github.com/greyson3hardy/PATH/issues/1857)
* **interview:** company red-flag detector from transcript signal ([0f4f16f](https://github.com/greyson3hardy/PATH/commit/0f4f16fafc941c0ed326a1344fb915eb649d83ed))
* **invite-match:** fuzzy-match interview-invite emails to tracker entries ([#1495](https://github.com/greyson3hardy/PATH/issues/1495)) ([10de9d4](https://github.com/greyson3hardy/PATH/commit/10de9d4ab48130d7c794028f00604ae8b9f56223))
* language.output preference — output language decoupled from market modes ([#1035](https://github.com/greyson3hardy/PATH/issues/1035)) ([4f512fb](https://github.com/greyson3hardy/PATH/commit/4f512fbdfa67057d7c06a37437a67f6f55428d45))
* **latex:** opt-in latex-tex in-place tailoring of user-owned .tex CVs ([#695](https://github.com/greyson3hardy/PATH/issues/695)) ([d7128ad](https://github.com/greyson3hardy/PATH/commit/d7128adfc877c39a82bc0f8edef83b4a5bc0bc0c))
* **ledger:** immutable n: ordinal per signature + first-contribution question for new signers ([8ec80b5](https://github.com/greyson3hardy/PATH/commit/8ec80b50d87c0ed3f145a74d62ce7f6771d929d1))
* **liveness:** add Workday to the zero-token ATS liveness API rung ([#1928](https://github.com/greyson3hardy/PATH/issues/1928)) ([f6afdf9](https://github.com/greyson3hardy/PATH/commit/f6afdf97c745de3fe9b6bdc3bb3198a6f412f3b0))
* make CLAUDE.md a thin @AGENTS.md wrapper — single canonical agent spec ([#272](https://github.com/greyson3hardy/PATH/issues/272)) ([09528a3](https://github.com/greyson3hardy/PATH/commit/09528a34c46a9914a255489729bdc79b0940ae9b))
* match employer reply candidates to application tracker ([#1607](https://github.com/greyson3hardy/PATH/issues/1607)) ([30df267](https://github.com/greyson3hardy/PATH/commit/30df267615c205ee5e2506af15288009808a9205)), closes [#1584](https://github.com/greyson3hardy/PATH/issues/1584)
* **modes:** add discover mode for AI-assisted opportunity search ([5092f85](https://github.com/greyson3hardy/PATH/commit/5092f850e0e85751ab03dddfa12c9c86bbef2ad0))
* **modes:** wire the opt-in CLI extractor into the oferta + auto-pipeline JD paths ([#1804](https://github.com/greyson3hardy/PATH/issues/1804)) ([3cb7c5b](https://github.com/greyson3hardy/PATH/commit/3cb7c5bdac2ada5ead4edb5bdadd1c2d769ac3f4))
* **oferta:** Block G signal 7 — AI-buzzword vs infrastructure mismatch ([#1683](https://github.com/greyson3hardy/PATH/issues/1683)) ([#1685](https://github.com/greyson3hardy/PATH/issues/1685)) ([7dda430](https://github.com/greyson3hardy/PATH/commit/7dda4302bbadd376444734bed36925072d0c3b97))
* **oferta:** Block G signal 9 — third-party platform location tag mismatch ([#1938](https://github.com/greyson3hardy/PATH/issues/1938)) ([add8497](https://github.com/greyson3hardy/PATH/commit/add849703ec66fc64633c519c3e1fc46f93b7386))
* **oferta:** Block G signal for benefits terminology country mismatch ([#1936](https://github.com/greyson3hardy/PATH/issues/1936)) ([3f0985d](https://github.com/greyson3hardy/PATH/commit/3f0985d3eaea97d6c3d6bc1468e092bcb0bc4ec3)), closes [#1935](https://github.com/greyson3hardy/PATH/issues/1935)
* **oferta:** company-type + compensation-reliability tiers in evaluations ([#1587](https://github.com/greyson3hardy/PATH/issues/1587)) ([160093c](https://github.com/greyson3hardy/PATH/commit/160093cbcc4b44cc22af34160a17422bd58a88b5))
* **oferta:** employment classification risk signal in Block G ([#1631](https://github.com/greyson3hardy/PATH/issues/1631)) ([1d084a2](https://github.com/greyson3hardy/PATH/commit/1d084a2d6c813e7e51e7a9c8c0d5dfe21ef2d820)), closes [#1630](https://github.com/greyson3hardy/PATH/issues/1630)
* **oferta:** flag 'remote' location contradicted by JD-body signals ([#1459](https://github.com/greyson3hardy/PATH/issues/1459)) ([74b8fcb](https://github.com/greyson3hardy/PATH/commit/74b8fcb1d0bdf0ae6b8563ff805a7b814919b9c1))
* offer-prep mode — contract reading companion at Offer stage ([#1634](https://github.com/greyson3hardy/PATH/issues/1634)) ([4490c4b](https://github.com/greyson3hardy/PATH/commit/4490c4b0dda09638592a51c522fb7a6f1e3c9f22)), closes [#1608](https://github.com/greyson3hardy/PATH/issues/1608)
* **offer-prep:** negotiation reply-draft step — draft-only email from Items to raise ([0e79229](https://github.com/greyson3hardy/PATH/commit/0e79229772a7a2bebf38f04179d4702642fa885f))
* **onboarding:** route to the manifesto from the README and the first successful scan ([e3a82e0](https://github.com/greyson3hardy/PATH/commit/e3a82e07dff4955d23dd97ea61aeccfc10810a9c))
* **onboarding:** surface the CareerOps Manifesto after updates and setup ([84f2e53](https://github.com/greyson3hardy/PATH/commit/84f2e534dfba7ac3831f0fda670bc6c3eaced788))
* **openai-eval:** host-gated prompt-cache breakpoint for the static prefix ([#1839](https://github.com/greyson3hardy/PATH/issues/1839)) ([4aad129](https://github.com/greyson3hardy/PATH/commit/4aad1292b7767ce2ce10c749b7368d7f1181d394))
* **openrouter:** prompt-cache the static system prefix via cache_control ([#1766](https://github.com/greyson3hardy/PATH/issues/1766)) ([4dacfc8](https://github.com/greyson3hardy/PATH/commit/4dacfc8b172653ecd99ea2223489cdf0c09df192))
* **path-dispatch:** add --contacts gate and dispatch write-back to the people ledger ([5e580cd](https://github.com/greyson3hardy/PATH/commit/5e580cd80fe009623ee3295da4c90f0119dfedaf))
* **path-dispatch:** add --send mode behind the existing approval gate ([c69a9a7](https://github.com/greyson3hardy/PATH/commit/c69a9a7ed9d84f3e40e0a6e8baa35e196d74e102))
* **path:** close learning-loop into weekly digest ([49c4d84](https://github.com/greyson3hardy/PATH/commit/49c4d84f446162d2d23caeedf13d76c3466f5ba7))
...
* **path:** close roadmap 1.2 career truth store + 1.3 learning loop ([#3](https://github.com/greyson3hardy/PATH/issues/3) [#10](https://github.com/greyson3hardy/PATH/issues/10)) ([0f5de2f](https://github.com/greyson3hardy/PATH/commit/0f5de2f33c44386984615cf12156867ff0268fe5))
* **path:** injectable remote-source fact seam + expand career truth store ([c6f2c2a](https://github.com/greyson3hardy/PATH/commit/c6f2c2a7fdf7067f99e831a38132f8a8038422a3))
...
* **path:** wire gemini provider through capability gateway + registry (Phase 2 PATH Brain) ([f4f8b7c](https://github.com/greyson3hardy/PATH/commit/f4f8b7c613a4b1f60354660d8d6cf0b08c2da3d9))
* **patterns:** ATS channel yield analysis — algorithmic-monoculture aware ([#1405](https://github.com/greyson3hardy/PATH/issues/1405)) ([c3b5d9a](https://github.com/greyson3hardy/PATH/commit/c3b5d9a815fdd5831d77c07a0c5767f4ae123a0c))
...
* **patterns:** recruiting-process friction signal at company level ([#1467](https://github.com/greyson3hardy/PATH/issues/1467)) ([dde05bc](https://github.com/greyson3hardy/PATH/commit/dde05bc9427e0752723be0c07ae3621aa46ed67d))
* **patterns:** transcript-driven targeting correction (Step 1b) — closes [#960](https://github.com/greyson3hardy/PATH/issues/960) ([#961](https://github.com/greyson3hardy/PATH/issues/961)) ([ed497fb](https://github.com/greyson3hardy/PATH/commit/ed497fb71d67bc1ad03c57d466e1463e205a4fc7))
* **pdf:** add role name to the tailored PDF filename for multi-role tracking ([#1890](https://github.com/greyson3hardy/PATH/issues/1890)) ([e878096](https://github.com/greyson3hardy/PATH/commit/e8780965d93f4d699d79b8d86d8e0c1f68f66437))
* **pdf:** allow intentional CV section reordering via --allow-reorder ([1a615d9](https://github.com/greyson3hardy/PATH/commit/1a615d9ced3a5ea23afe17ddef031d85861f8b3b))
* **pdf:** deterministic HTML CV renderer to cut PDF-step token burn ([#557](https://github.com/greyson3hardy/PATH/issues/557)) ([#1681](https://github.com/greyson3hardy/PATH/issues/1681)) ([1e08297](https://github.com/greyson3hardy/PATH/commit/1e082972be2368d61937a05c681f7f0737b91eb9))
* **pdf:** first-class zh-CN typography support ([#1989](https://github.com/greyson3hardy/PATH/issues/1989)) ([ed487f2](https://github.com/greyson3hardy/PATH/commit/ed487f280fbd6dfd6c1cfefe3d80fa5e4cebf28b))
* **pdf:** JD skill-gap checker before CV generation, zero-LLM ([#1559](https://github.com/greyson3hardy/PATH/issues/1559)) ([8afdf0b](https://github.com/greyson3hardy/PATH/commit/8afdf0be0e3d8fa3e0fb351750a34fb08fcf3e39)), closes [#1558](https://github.com/greyson3hardy/PATH/issues/1558)
* **pdf:** warn on rendered page overflow, --strict-pages opt-in hard limit ([#1797](https://github.com/greyson3hardy/PATH/issues/1797)) ([f630914](https://github.com/greyson3hardy/PATH/commit/f630914e8b557f1385fb7c98bdc3442b93c058df))
* **pipeline:** openai-tailor.mjs — headless CV tailoring for the no-agent path ([#1669](https://github.com/greyson3hardy/PATH/issues/1669)) ([#1671](https://github.com/greyson3hardy/PATH/issues/1671)) ([4abce71](https://github.com/greyson3hardy/PATH/commit/4abce712a3809aebabd30750d288c758dfad9d2b))
...
* **pipeline:** per-step token breakdown at end of run ([#2022](https://github.com/greyson3hardy/PATH/issues/2022)) ([8fca469](https://github.com/greyson3hardy/PATH/commit/8fca469745aa99f77da6cc8b64f8f6cf0eb9565d))
* **plugins:** seed/successor model — community plugins can supersede a bundled reference ([fa61b0c](https://github.com/greyson3hardy/PATH/commit/fa61b0cfcb84b16c01c07ea3ade0b03a0bae5061))
* **portals:** probe non-ATS boards through the provider layer ([#1529](https://github.com/greyson3hardy/PATH/issues/1529)) ([ba83606](https://github.com/greyson3hardy/PATH/commit/ba836064cea7a99873fc383b254c32a59d07f4dc))
* **profile:** candidate contact-channel preference for outreach CTAs ([#1557](https://github.com/greyson3hardy/PATH/issues/1557)) ([03a17b5](https://github.com/greyson3hardy/PATH/commit/03a17b5874578aab54e2ef9d36702e9c73ba6cf7)), closes [#1556](https://github.com/greyson3hardy/PATH/issues/1556)
* **providers:** 4dayweek auto-detect with spoof-safe host matching ([#1657](https://github.com/greyson3hardy/PATH/issues/1657) follow-up) ([333d620](https://github.com/greyson3hardy/PATH/commit/333d6203f770efcd52c5a7cf05ce5d5cb0811337))
* **providers:** add Alibaba Group careers provider ([#2055](https://github.com/greyson3hardy/PATH/issues/2055)) ([cc2e567](https://github.com/greyson3hardy/PATH/commit/cc2e567c3ccff885e24a462d1b1074819b3f7d63))
* **providers:** add Gem scanner provider ([#2024](https://github.com/greyson3hardy/PATH/issues/2024)) ([6579bdf](https://github.com/greyson3hardy/PATH/commit/6579bdfa9ec24c3d038ce283ab7ca25950facd3a))
* **providers:** add Get on Board (getonbrd) zero-auth provider ([#1442](https://github.com/greyson3hardy/PATH/issues/1442)) ([c53a61c](https://github.com/greyson3hardy/PATH/commit/c53a61c7998f7cdfbf59500deb27493ad3d4ce18))
* **providers:** add HigherEdJobs RSS provider ([#1350](https://github.com/greyson3hardy/PATH/issues/1350)) ([d280a7d](https://github.com/greyson3hardy/PATH/commit/d280a7dee24e9225c03f30cd0f47b78c56a14e76))
* **providers:** add JibeApply provider ([#1400](https://github.com/greyson3hardy/PATH/issues/1400)) ([311ed4a](https://github.com/greyson3hardy/PATH/commit/311ed4a0319d8ad4e8437c5c906d4d97255317f1))
* **providers:** add Jobvite zero-auth provider ([#1572](https://github.com/greyson3hardy/PATH/issues/1572)) ([be07d6b](https://github.com/greyson3hardy/PATH/commit/be07d6b8c903225e652ba0436f6f1fd24a2904e7))
* **providers:** add LaraJobs zero-auth RSS provider ([0f046b5](https://github.com/greyson3hardy/PATH/commit/0f046b5bd7f24a7ec13ba4a027183ca765d869ca))
* **providers:** add Lever EU instance (jobs.eu.lever.co) ([#1571](https://github.com/greyson3hardy/PATH/issues/1571)) ([bd81e37](https://github.com/greyson3hardy/PATH/commit/bd81e37181c0dab0a9d4c7e4c09a3e74997a7515))
* **providers:** add Meituan careers provider ([#1818](https://github.com/greyson3hardy/PATH/issues/1818)) ([0f6b096](https://github.com/greyson3hardy/PATH/commit/0f6b0966ab0f3fef22209513d1af3c949abdd787))
* **providers:** add Oracle Recruiting Cloud zero-auth provider ([#1929](https://github.com/greyson3hardy/PATH/issues/1929)) ([52db048](https://github.com/greyson3hardy/PATH/commit/52db0484b7a506173b055bf23edcba4593233bb9))
* **providers:** add Teamtailor zero-auth RSS provider ([#1376](https://github.com/greyson3hardy/PATH/issues/1376)) ([eea80e9](https://github.com/greyson3hardy/PATH/commit/eea80e960a845645e7b68a5057227d26ff834713))
* **providers:** add Tencent careers zero-auth provider ([#230](https://github.com/greyson3hardy/PATH/issues/230)) ([95ba35c](https://github.com/greyson3hardy/PATH/commit/95ba35cfe3f7b6163959d21a493ba156bf524536))
* **providers:** add Welcome to the Jungle and Agentic Engineering Jobs providers ([#1808](https://github.com/greyson3hardy/PATH/issues/1808)) ([e0a8dc7](https://github.com/greyson3hardy/PATH/commit/e0a8dc73a2f882fd3b078ea24beb2df3927e2860))
* **providers:** Amazon (amazon.jobs) and Avature zero-token providers ([#1480](https://github.com/greyson3hardy/PATH/issues/1480)) ([494e947](https://github.com/greyson3hardy/PATH/commit/494e9476cf215e336c255ac5a06fab231a2b256a))
* **providers:** avature self-heals jobOffset→offset pagination ([#1547](https://github.com/greyson3hardy/PATH/issues/1547)) ([7f1a171](https://github.com/greyson3hardy/PATH/commit/7f1a171c23c8f57096223fdf8220e274f2f5c1bc))
* **providers:** beesite (milch & zucker) + softgarden providers ([#1551](https://github.com/greyson3hardy/PATH/issues/1551)) ([220288e](https://github.com/greyson3hardy/PATH/commit/220288e93753933ceafe12f7bcb71ae6788bdeb0))
* **providers:** Cornerstone OnDemand (csod) + Rheinmetall ([#1549](https://github.com/greyson3hardy/PATH/issues/1549)) ([ffbbf41](https://github.com/greyson3hardy/PATH/commit/ffbbf41fb35df1a7b97cdcffecc3438d5e64ec86))
* **providers:** Dassault Systèmes zero-token provider (Exalead XML) ([#1498](https://github.com/greyson3hardy/PATH/issues/1498)) ([46c0e89](https://github.com/greyson3hardy/PATH/commit/46c0e894daf93d3ac1c683f98fb3bd27e8b1da24))
* **providers:** EchoJobs zero-auth JSON aggregator provider ([#1655](https://github.com/greyson3hardy/PATH/issues/1655)) ([9509882](https://github.com/greyson3hardy/PATH/commit/95098823e1150af51e9811c796f5a43d8ad8f5a7))
* **providers:** honour api: on workday and smartrecruiters ([#1496](https://github.com/greyson3hardy/PATH/issues/1496)) ([f77f846](https://github.com/greyson3hardy/PATH/commit/f77f8465a5dc79faed00c6e9510eea3fba76a4ca))
* **providers:** Phenom People (phenom) + Radancy TalentBrew (radancy) ([#1554](https://github.com/greyson3hardy/PATH/issues/1554)) ([e638fed](https://github.com/greyson3hardy/PATH/commit/e638fed2c00ceef9475e79922ac85fed1302a0b7))
* **providers:** SAP SuccessFactors (RMK) zero-token provider ([#1475](https://github.com/greyson3hardy/PATH/issues/1475)) ([67253c4](https://github.com/greyson3hardy/PATH/commit/67253c49638ef565a32a4aa9f98ef2c895adee5b))
* **providers:** SuccessFactors CSB strategy + bounded health-probe budget ([#1548](https://github.com/greyson3hardy/PATH/issues/1548)) ([81ab0ed](https://github.com/greyson3hardy/PATH/commit/81ab0ede1ac8592ced56b7904627f588092f837e))
* **providers:** TKMS, Heckler & Koch, and Deutsche Bahn providers ([#1555](https://github.com/greyson3hardy/PATH/issues/1555)) ([1422846](https://github.com/greyson3hardy/PATH/commit/14228466983f11a19bef1d311e92dbd365b4f221))
* record Path approval decisions ([6dadfa2](https://github.com/greyson3hardy/PATH/commit/6dadfa2f3c4bd39106fd8e41ce76a47a3b581ce0))
* **recruiter:** advisory prior-contact note in run summary ([725f4bb](https://github.com/greyson3hardy/PATH/commit/725f4bbbc12ed4c714b831606632ab567c5dbfd2))
* **registry:** add career-ops-plugin-markdown v0.1.0 ([708fa8b](https://github.com/greyson3hardy/PATH/commit/708fa8b34069d30c74a7dc73b0e58cd4c9339eb7))
* **registry:** add career-ops-plugin-obsidian v0.1.0 ([#1399](https://github.com/greyson3hardy/PATH/issues/1399)) ([1b26648](https://github.com/greyson3hardy/PATH/commit/1b26648b148fd4efc345ad098c5f46d261e81d83))
* **registry:** add career-ops-plugin-tavily v0.1.0 ([#1348](https://github.com/greyson3hardy/PATH/issues/1348)) ([b5aa464](https://github.com/greyson3hardy/PATH/commit/b5aa464857ee141b03f376eb70c8614b2a24ca98))
* **registry:** add google-calendar plugin v0.1.0 ([#1347](https://github.com/greyson3hardy/PATH/issues/1347)) ([1ebc81f](https://github.com/greyson3hardy/PATH/commit/1ebc81fe17087efd4d318345b7b90d627e0b3c27))
* **registry:** add startup boards plugin ([#1413](https://github.com/greyson3hardy/PATH/issues/1413)) ([f2e1d08](https://github.com/greyson3hardy/PATH/commit/f2e1d080ca9eaa8022a53cc91eef313071892aa7))
* **registry:** register serper and theirstack provider plugins ([#1645](https://github.com/greyson3hardy/PATH/issues/1645), [#1697](https://github.com/greyson3hardy/PATH/issues/1697)) ([2958a2c](https://github.com/greyson3hardy/PATH/commit/2958a2c4b8d3c851758728b6e17e5b739d077c09))
* **registry:** split plugins-registry.json into per-plugin files ([#1401](https://github.com/greyson3hardy/PATH/issues/1401)) ([6d08316](https://github.com/greyson3hardy/PATH/commit/6d08316722f96af88f74959992d8bbab8c1d4228))
* **reply-watch:** paste-reply.mjs manual input path for users without Gmail ([#1803](https://github.com/greyson3hardy/PATH/issues/1803)) ([4f9e924](https://github.com/greyson3hardy/PATH/commit/4f9e9244ef556286993d9ef6bc8c49cd59f98275)), closes [#1802](https://github.com/greyson3hardy/PATH/issues/1802)
* **reports:** unified Risk Summary block joining the five company-risk signals ([#1738](https://github.com/greyson3hardy/PATH/issues/1738)) ([f0c742a](https://github.com/greyson3hardy/PATH/commit/f0c742a835dd03411b193d28540a3dd300cb2dc0)), closes [#1737](https://github.com/greyson3hardy/PATH/issues/1737)
* **reserve-report-num:** --count N contiguous range reservation ([#1454](https://github.com/greyson3hardy/PATH/issues/1454)) ([a70dd61](https://github.com/greyson3hardy/PATH/commit/a70dd61391d6ee4c7706b9d001dcd833b84547a9))
* **salary-gap:** track compensation figures stated per interview round ([#1853](https://github.com/greyson3hardy/PATH/issues/1853)) ([8308cd1](https://github.com/greyson3hardy/PATH/commit/8308cd1bbdf2231c743085062e049f0c751c1727)), closes [#1852](https://github.com/greyson3hardy/PATH/issues/1852)
* **salary:** mode wiring — advertised_comp + observation appends ([f0414ec](https://github.com/greyson3hardy/PATH/commit/f0414ec0f0e0ae2b86fa6a6e4bba602a721d1749))
* **salary:** salary-gap.mjs — append-only compensation observation analyzer ([8c6dcdd](https://github.com/greyson3hardy/PATH/commit/8c6dcddaaa14f61308b21b04004d2523f7514357))
* **scan:** --posted-after/--posted-before absolute posting-date filters ([#2067](https://github.com/greyson3hardy/PATH/issues/2067)) ([e8ba1a4](https://github.com/greyson3hardy/PATH/commit/e8ba1a42beec3a638f34a862d238f5e42174dcb1))
* **scan:** add seniority-tier classifier with optional skip_tiers fi… ([#1361](https://github.com/greyson3hardy/PATH/issues/1361)) ([db6cbce](https://github.com/greyson3hardy/PATH/commit/db6cbce03e9290549488a801544ad4a74746c7b5))
* **scan:** add visa_filter for surfacing visa-sponsoring roles ([#1662](https://github.com/greyson3hardy/PATH/issues/1662)) ([995c1dd](https://github.com/greyson3hardy/PATH/commit/995c1ddab6eb1b3aba2fb7ef3e41ff2eb601cc6b)), closes [#2057](https://github.com/greyson3hardy/PATH/issues/2057)
* **scan:** data/blacklist.md — user-owned do-not-apply list ([#1742](https://github.com/greyson3hardy/PATH/issues/1742)) ([#1748](https://github.com/greyson3hardy/PATH/issues/1748)) ([9867d0e](https://github.com/greyson3hardy/PATH/commit/9867d0e7fa33fce009511acebe526755e326c244))
* **scan:** JD-content fingerprinting — flag agency+direct cross-listings ([#1601](https://github.com/greyson3hardy/PATH/issues/1601)) ([52154fd](https://github.com/greyson3hardy/PATH/commit/52154fd8544fcf949be7c430daa8def5c9319471)), closes [#1597](https://github.com/greyson3hardy/PATH/issues/1597)
* **scan:** opt-in CLI page extractor (browser-extract.mjs) ([557a97d](https://github.com/greyson3hardy/PATH/commit/557a97d44d7b6574fab8c5b61f448caba8bc08e2))
* **scan:** opt-in max_posting_age_days freshness gate ([#1578](https://github.com/greyson3hardy/PATH/issues/1578)) ([8b60a8c](https://github.com/greyson3hardy/PATH/commit/8b60a8cfbe487ce0254432695bab1c2989041df9))
* **scan:** persist and surface the scanner trust signal to pipeline and history ([#1765](https://github.com/greyson3hardy/PATH/issues/1765)) ([16c8497](https://github.com/greyson3hardy/PATH/commit/16c84976b1d39187edd22f6610c48049d00c79d6)), closes [#1743](https://github.com/greyson3hardy/PATH/issues/1743)
* **scan:** persist per-run scan counters to data/scan-runs.tsv ([#1606](https://github.com/greyson3hardy/PATH/issues/1606)) ([d0d9bd0](https://github.com/greyson3hardy/PATH/commit/d0d9bd05d75e87d2ab21a6ca440cc4ddd92c919b))
* **scan:** persist provider postedAt to pipeline and scan-history ([#1578](https://github.com/greyson3hardy/PATH/issues/1578)) ([300b6cb](https://github.com/greyson3hardy/PATH/commit/300b6cb613aff388eea632960c3d15110ee9411b))
* **scan:** report unreachable boards with error classification + doctor sweep ([#1455](https://github.com/greyson3hardy/PATH/issues/1455)) ([fd3635f](https://github.com/greyson3hardy/PATH/commit/fd3635f67fc4a83be922306c7d18fb6fb74a296e))
* **scan:** scope content_filter per title-category via by_title_keyword ([9c5791b](https://github.com/greyson3hardy/PATH/commit/9c5791bf934d8e909944f6b8e232fc8326954774))
* **scan:** suppress duplicate roles via company aliases ([#1750](https://github.com/greyson3hardy/PATH/issues/1750)) ([b203ea4](https://github.com/greyson3hardy/PATH/commit/b203ea4183d78b22ca57045a9f9f94d716ef6036))
* **scan:** track portal health over time and surface coverage decay ([#1768](https://github.com/greyson3hardy/PATH/issues/1768)) ([9bc82e2](https://github.com/greyson3hardy/PATH/commit/9bc82e28620d1db6702b075f651a4ff991208bed)), closes [#1744](https://github.com/greyson3hardy/PATH/issues/1744)
* **scoring:** culture-screen dimension with structural capping ([dc2a8d8](https://github.com/greyson3hardy/PATH/commit/dc2a8d86464bdc719c709f6e0ab5554d83993074))
* spend_tier config for model-agnostic model routing + batch pre-screen gate ([#1007](https://github.com/greyson3hardy/PATH/issues/1007)) ([4dec7eb](https://github.com/greyson3hardy/PATH/commit/4dec7eb2da549ad4712111eaece4719390efbe94))
* **stats:** lifetime pipeline stats aggregator ([#1605](https://github.com/greyson3hardy/PATH/issues/1605)) ([1b23baa](https://github.com/greyson3hardy/PATH/commit/1b23baa1159c01884a6dab54136031a1b5945097))
* **templates:** config-selectable CV and cover-letter templates ([#1690](https://github.com/greyson3hardy/PATH/issues/1690)) ([#1691](https://github.com/greyson3hardy/PATH/issues/1691)) ([7576cfd](https://github.com/greyson3hardy/PATH/commit/7576cfd8deb28eb0b7dd1a7c96cae8f44a91091d))
* titles mode — suggest adjacent job titles from the CV ([#1637](https://github.com/greyson3hardy/PATH/issues/1637)) ([2d7bb04](https://github.com/greyson3hardy/PATH/commit/2d7bb04247950ec4fbcf1f956895334b04daf349)), closes [#1632](https://github.com/greyson3hardy/PATH/issues/1632)
* **tracker:** assessment-log.mjs — skills-assessment events with staleness signal ([#1684](https://github.com/greyson3hardy/PATH/issues/1684)) ([#1687](https://github.com/greyson3hardy/PATH/issues/1687)) ([d1be88b](https://github.com/greyson3hardy/PATH/commit/d1be88bb7b15839a4ee89841ee6ae582df7eb0ee))
* **tracker:** recognize "—"/"-" as valid score-cell N/A sentinels ([#1800](https://github.com/greyson3hardy/PATH/issues/1800)) ([7280df2](https://github.com/greyson3hardy/PATH/commit/7280df2b84e734a2080552d77d9d1afefe8b67cb)), closes [#1799](https://github.com/greyson3hardy/PATH/issues/1799)
* **tracker:** set-status.mjs — canonical CLI for tracker status updates ([#1460](https://github.com/greyson3hardy/PATH/issues/1460)) ([1750e4c](https://github.com/greyson3hardy/PATH/commit/1750e4c2f26b92b4b7bfd9013c03198361a93b1e)), closes [#1428](https://github.com/greyson3hardy/PATH/issues/1428)
...
* **upskill:** aggregate skill-gap analysis from tracked reports ([#1520](https://github.com/greyson3hardy/PATH/issues/1520), phase 1) ([fd1f3c9](https://github.com/greyson3hardy/PATH/commit/fd1f3c957b4ab138850c0ceccef7c4d3a9720093))
* **upskill:** targeted &lt;URL&gt; single-posting mode with SSRF-guarded fetch ([#1796](https://github.com/greyson3hardy/PATH/issues/1796)) ([72e5983](https://github.com/greyson3hardy/PATH/commit/72e59839f8cce573f41031f41499ed63104b1d57)), closes [#1739](https://github.com/greyson3hardy/PATH/issues/1739)
* **verify:** detect duplicate and orphan reports ([#1425](https://github.com/greyson3hardy/PATH/issues/1425)) ([#1441](https://github.com/greyson3hardy/PATH/issues/1441)) ([5c42df3](https://github.com/greyson3hardy/PATH/commit/5c42df3613c4839055a769f81be595677a973c74))
...
* **agents:** compress AGENTS.md ~20% with zero semantic loss ([#2094](https://github.com/greyson3hardy/PATH/issues/2094)) ([bd7b377](https://github.com/greyson3hardy/PATH/commit/bd7b3771dbb72bbc38d4e80fc281b25442d9bbaf))
* **analyzer:** resolve report paths relative to the tracker file ([#1679](https://github.com/greyson3hardy/PATH/issues/1679)) ([568025c](https://github.com/greyson3hardy/PATH/commit/568025c4677772b0882afbce3609c30ac1a3f7e8))
* **arbeitsagentur:** only tag nationwide-remote when homeofficetyp is VOLLSTAENDIG ([#1981](https://github.com/greyson3hardy/PATH/issues/1981)) ([b3b466c](https://github.com/greyson3hardy/PATH/commit/b3b466ca69ca8bb6eb9d7e6484ed340faa10a607))
* **contacts:** keep in-memory ledger in sync during backfill run ([d3ec51c](https://github.com/greyson3hardy/PATH/commit/d3ec51ccac20e88058a44114f1fb4e2267eba5de))
...
* **cover:** resolve the cover-letter template through the shared resolver ([#1777](https://github.com/greyson3hardy/PATH/issues/1777)) ([7e1775c](https://github.com/greyson3hardy/PATH/commit/7e1775c483c70da7dc4e63cd9e78cbb286d7c8cf))
* **cv-template:** keep role header with its bullets when a location line is present ([#1903](https://github.com/greyson3hardy/PATH/issues/1903)) ([66b1024](https://github.com/greyson3hardy/PATH/commit/66b102490943d93ed3afd384b6fbc1e47c5d7d48))
* **dashboard:** duplicate tracker headers resolve last-occurrence to match JS reader ([#1602](https://github.com/greyson3hardy/PATH/issues/1602)) ([edbfd8d](https://github.com/greyson3hardy/PATH/commit/edbfd8d4e4a395ced64fef13fea6d72c010dab08))
* **dedup:** require exact company+role match so distinct same-company roles survive ([#1458](https://github.com/greyson3hardy/PATH/issues/1458)) ([4f387f0](https://github.com/greyson3hardy/PATH/commit/4f387f04e44253c43462c5083e298cfb09a3c844))
...
* **desktop:** call checkoutCandidates() in packaged resolveRepo() ([b9718a3](https://github.com/greyson3hardy/PATH/commit/b9718a3bb4a3384b4e3ba3a8f7b30f9dad690deb))
* **doctor:** treat missing user prerequisites as non-fatal setup warnings ([#2083](https://github.com/greyson3hardy/PATH/issues/2083)) ([a3cf654](https://github.com/greyson3hardy/PATH/commit/a3cf6541d2104e4cad307ffbe93713ef18d31655))
* **doctor:** warn when Node is below 22.5 instead of passing silently ([#1831](https://github.com/greyson3hardy/PATH/issues/1831)) ([30e470d](https://github.com/greyson3hardy/PATH/commit/30e470dea58f06e077d920c0cf1f70f24f74bbbc)), closes [#1829](https://github.com/greyson3hardy/PATH/issues/1829)
* drop stale plugins-registry.json from updater path manifests ([#2070](https://github.com/greyson3hardy/PATH/issues/2070)) ([44bf9f6](https://github.com/greyson3hardy/PATH/commit/44bf9f68159fadabb871ce00b2c5e5bafb6918ab))
* **envrc:** only load the Nix flake when Nix is installed ([#1863](https://github.com/greyson3hardy/PATH/issues/1863)) ([ca23af6](https://github.com/greyson3hardy/PATH/commit/ca23af67b40d83bac3f705467f1fb322a7cefe54))
* **followup-cadence:** schedule first responded follow-up with responded_initial ([#1352](https://github.com/greyson3hardy/PATH/issues/1352)) ([e30dd0b](https://github.com/greyson3hardy/PATH/commit/e30dd0b3ec3a360dfa3d68f81f845c0269a8cf9a))
* gitignore data/active-interviews.md (user interview data) ([267dfb7](https://github.com/greyson3hardy/PATH/commit/267dfb7079877e2beb2a949eb7b404b7bd257332))
* **gmail-replies:** blocklist matching is subdomain-suffix, not exact-domain ([fb2a6aa](https://github.com/greyson3hardy/PATH/commit/fb2a6aa8bf47e428dec5ea18b9baa0474cf3884a))
* **gmail-replies:** bracket-lookup gmail-replies config key (hyphenated plugin block) ([591dee9](https://github.com/greyson3hardy/PATH/commit/591dee9fe290b492e65d35a98190b5c82058eb34))
* **gmail-replies:** correct body_snippet precedence in plan parseMessage ([baeed88](https://github.com/greyson3hardy/PATH/commit/baeed887280ad9cc1b83fb03e33b05ddada78c80))
* **gmail-replies:** restore missing UTF-8 ellipsis in parseMessage fixture ([41f3aff](https://github.com/greyson3hardy/PATH/commit/41f3affab6becff492124c2c6a38022a79e1d224))
* honor output language in headless evaluators ([#1916](https://github.com/greyson3hardy/PATH/issues/1916)) ([c2384cd](https://github.com/greyson3hardy/PATH/commit/c2384cdd17335c6bfec9b19ce655ea9cfe784c18))
* ignore logo cache directory ([#1577](https://github.com/greyson3hardy/PATH/issues/1577)) ([f51b948](https://github.com/greyson3hardy/PATH/commit/f51b948fb9a7902d4da017840ea83e9dd1d21f6c))
* **infra:** exempt web/ from the SYSTEM_PATHS coverage guard (isolation contract) ([8a23564](https://github.com/greyson3hardy/PATH/commit/8a235649881dc5fa5f4511accf154355da155ade))
* **interview-redflag:** drop GitHub PR references from candidate-facing output templates ([aa35162](https://github.com/greyson3hardy/PATH/commit/aa35162f47b09f92e892cb0d6aa9c59dffb8673b))
* **ledger-bot:** make the first-contribution confirmation copy match what ships ([89e1741](https://github.com/greyson3hardy/PATH/commit/89e17418bcf8d177f27a768c5282f0ecdb81cd85))
* **ledger-bot:** restore the 'done' confirmation now that the certificate render is live ([9c033d2](https://github.com/greyson3hardy/PATH/commit/9c033d20f319b412e879539cee4aef864582084a))
* **liveness:** add Ashby API rung so live jobs.ashbyhq.com postings aren't false-expired ([#1372](https://github.com/greyson3hardy/PATH/issues/1372)) ([b7bc6f3](https://github.com/greyson3hardy/PATH/commit/b7bc6f38497ff423de3865f6ad729b0f511a8adf))
* **liveness:** treat off-posting redirects as uncertain, not active ([c1cd458](https://github.com/greyson3hardy/PATH/commit/c1cd4586606f67aa87f263ee21bc165443851bca))
* load profile and custom rules deterministically in all mode paths ([#1736](https://github.com/greyson3hardy/PATH/issues/1736)) ([#1759](https://github.com/greyson3hardy/PATH/issues/1759)) ([738a5c7](https://github.com/greyson3hardy/PATH/commit/738a5c7969ffc51ec4546e0e8b33a9cbe6cf0fe0))
* **merge-tracker:** detect TSV score/status column order by header ([#1517](https://github.com/greyson3hardy/PATH/issues/1517)) ([423fc1f](https://github.com/greyson3hardy/PATH/commit/423fc1f45ed9e6a5b6e1ed623e14a67a028ccea7)), closes [#1427](https://github.com/greyson3hardy/PATH/issues/1427)
* **merge-tracker:** guard tier-3 fuzzy dedup with req/job number ([#1525](https://github.com/greyson3hardy/PATH/issues/1525)) ([fdb4376](https://github.com/greyson3hardy/PATH/commit/fdb4376f39051db7102bf48eb0ec8d73cafb7ef9)), closes [#1524](https://github.com/greyson3hardy/PATH/issues/1524)
* **merge-tracker:** preserve empty interior cells in tracker-row parsing ([#1824](https://github.com/greyson3hardy/PATH/issues/1824)) ([a477638](https://github.com/greyson3hardy/PATH/commit/a477638b30a19d95a4a47db5938fb600fb0f75da))
* **modes:** enforce modes/_custom.md overrides across mode files ([#1621](https://github.com/greyson3hardy/PATH/issues/1621)) ([1d87f1e](https://github.com/greyson3hardy/PATH/commit/1d87f1e208d3ca5e38d7afdd76b44d24b976597b)), closes [#1618](https://github.com/greyson3hardy/PATH/issues/1618)
* **modes:** wire modes/_custom.md into the read path — house rules were write-only ([76b45a8](https://github.com/greyson3hardy/PATH/commit/76b45a8997135d8bfaf245876a987264d803b7cb))
* **ollama-eval:** move temperature into options where Ollama reads it ([#1842](https://github.com/greyson3hardy/PATH/issues/1842)) ([77864e5](https://github.com/greyson3hardy/PATH/commit/77864e537cdc7f08c6b888e13916e4c215529d84))
* **onboarding:** auto-copy template seeds in doctor --json ([#782](https://github.com/greyson3hardy/PATH/issues/782), [#1369](https://github.com/greyson3hardy/PATH/issues/1369)) ([#1369](https://github.com/greyson3hardy/PATH/issues/1369)) ([3c06b46](https://github.com/greyson3hardy/PATH/commit/3c06b461903ce2d8c935862b433a1ff2b65039dc))
* **onboarding:** relay the manifesto note in agent-mediated updates ([0a3abed](https://github.com/greyson3hardy/PATH/commit/0a3abeddfa66ceb2f3e63f5f951fbbcb85481a4b))
* **path:** gate followup-cadence CLI arg parsing behind entry-point check ([8f81964](https://github.com/greyson3hardy/PATH/commit/8f81964ff28d5d2bf3782b1eb1eafcfe337a2fe2))
* **paths:** prefer cygpath over wslpath in toBashPath() ([#1503](https://github.com/greyson3hardy/PATH/issues/1503)) ([b4f5a83](https://github.com/greyson3hardy/PATH/commit/b4f5a83618de4ef90c26ea2130c0bb6dc44d2a85))
* **pdf:** clean temporary HTML when browser launch fails ([#1786](https://github.com/greyson3hardy/PATH/issues/1786)) ([2c17f04](https://github.com/greyson3hardy/PATH/commit/2c17f04b842910725ae34ff93bdd62c7aeabd7d7))
* **pdf:** drop empty Education section instead of rendering a bare header ([#2063](https://github.com/greyson3hardy/PATH/issues/2063)) ([46d1585](https://github.com/greyson3hardy/PATH/commit/46d15851a868d8b89c90437f7f8ed4cdf0029883))
* **pdf:** drop empty Projects section instead of rendering a bare header ([#1879](https://github.com/greyson3hardy/PATH/issues/1879)) ([a64d590](https://github.com/greyson3hardy/PATH/commit/a64d59063d234ed65175491da37f83a47f0a35b4))
* **pdf:** explain the agentic HTML flow in generate-pdf.mjs usage output ([7ae6eb0](https://github.com/greyson3hardy/PATH/commit/7ae6eb0fba5702638518da7e141cdfbb68491582))
* **pdf:** harden optional-section boundaries, extract shared cv-sections-core ([#2072](https://github.com/greyson3hardy/PATH/issues/2072)) ([90c1ed4](https://github.com/greyson3hardy/PATH/commit/90c1ed4c281cb30f2d49a31889984b730762100f))
* **pdf:** keep a right gutter so right-aligned CV content isn't clipped ([#1341](https://github.com/greyson3hardy/PATH/issues/1341)) ([#1351](https://github.com/greyson3hardy/PATH/issues/1351)) ([37c0703](https://github.com/greyson3hardy/PATH/commit/37c07033de3cf872a9f40cc2ca33f400a1192db7))
* **pdf:** render markdown bold in CV summary as &lt;strong&gt; (ATS-safe) ([b12cf41](https://github.com/greyson3hardy/PATH/commit/b12cf41016974d5edce45e346021b3b3861a7fde))
* **pdf:** use CSS [@page](https://github.com/page) setup for margins ([#1563](https://github.com/greyson3hardy/PATH/issues/1563)) ([d057218](https://github.com/greyson3hardy/PATH/commit/d057218e0aa1124002b38134e277e8c76e575b38))
* **pipeline:** recognize [#1799](https://github.com/greyson3hardy/PATH/issues/1799) score sentinels in verify-pipeline ([#2069](https://github.com/greyson3hardy/PATH/issues/2069)) ([df26599](https://github.com/greyson3hardy/PATH/commit/df2659949fda33f71cceded4782cb592e93f7edd))
* **plugin:** mirror plugin.json at .github/plugin/ for the awesome-copilot validator ([11fd356](https://github.com/greyson3hardy/PATH/commit/11fd3565f7b449f44775a6d0e9efb668ffd945fb))
* **plugins:** harden manifest path containment against symlink traversal ([#1532](https://github.com/greyson3hardy/PATH/issues/1532)) ([9d0be62](https://github.com/greyson3hardy/PATH/commit/9d0be62f20c45d3b4892a54f780f28a0baf399f0))
* **portals:** validator accepts provider-plugin ids like the runtime does ([#1756](https://github.com/greyson3hardy/PATH/issues/1756)) ([eee7ec0](https://github.com/greyson3hardy/PATH/commit/eee7ec0546e319ca93140608fc125669fbb737b2))
* prevent notion plugin from mangling slash-formatted scores ([#1414](https://github.com/greyson3hardy/PATH/issues/1414)) ([#1417](https://github.com/greyson3hardy/PATH/issues/1417)) ([6ea2e5f](https://github.com/greyson3hardy/PATH/commit/6ea2e5f63a172d00e5e64712bc8fb72d6562b680))
* prevent role-matcher from collapsing different seniorities ([#1622](https://github.com/greyson3hardy/PATH/issues/1622)) ([dd45bcb](https://github.com/greyson3hardy/PATH/commit/dd45bcbbdb425caa61183fe02336c51d440598b3)), closes [#1616](https://github.com/greyson3hardy/PATH/issues/1616)
* **providers:** avature parser tolerates two live tenant markup variants ([#1541](https://github.com/greyson3hardy/PATH/issues/1541)) ([1f59f2b](https://github.com/greyson3hardy/PATH/commit/1f59f2b6ade03883372e4acb011e8194e43e7a2a))
* **providers:** build public SmartRecruiters URLs without /postings/ ([#2047](https://github.com/greyson3hardy/PATH/issues/2047)) ([4624242](https://github.com/greyson3hardy/PATH/commit/4624242367056d7c118249279c80b8bb8da62b04))
* **providers:** harden workday pagination against 429s, API caps, and dateless tenants ([#1419](https://github.com/greyson3hardy/PATH/issues/1419)) ([13f80d5](https://github.com/greyson3hardy/PATH/commit/13f80d5643f360b1702d40d449ca330a07752b0d))
* **providers:** support explicit api: override for ashby/lever with host-pinned guards ([6e010fe](https://github.com/greyson3hardy/PATH/commit/6e010fe9613ae16fa08b6a291473128c1097af2e))
* **providers:** update Glints API to v2-alc/searchJobsV3, document Jobstreet GraphQL migration ([#1173](https://github.com/greyson3hardy/PATH/issues/1173)) ([cf863f7](https://github.com/greyson3hardy/PATH/commit/cf863f721585bba32ee6409d708a59afe37b1631))
* **providers:** workday honors ctx.maxPages so the liveness probe stops cleanly ([#1553](https://github.com/greyson3hardy/PATH/issues/1553)) ([39216f0](https://github.com/greyson3hardy/PATH/commit/39216f0661b861d78c5d6700d864a0b9b83e6478))
* **reserve-report-num:** support report numbers past 999 ([#1785](https://github.com/greyson3hardy/PATH/issues/1785)) ([e53b08e](https://github.com/greyson3hardy/PATH/commit/e53b08e9ba7a48ed50da69bb58d7a463318821ea))
* restore the Kimi SKILL.md entrypoint as a real symlink ([82e86a0](https://github.com/greyson3hardy/PATH/commit/82e86a0e8ec7e4985028ac26e87f71a55968d430))
* **role-matcher:** keep base titles distinct from specialized-suffix siblings ([#1922](https://github.com/greyson3hardy/PATH/issues/1922)) ([723f727](https://github.com/greyson3hardy/PATH/commit/723f727f739e56fe8ad147c124f01851d1649f4d)), closes [#1881](https://github.com/greyson3hardy/PATH/issues/1881)
* **scan-ats-full:** reject unrecognized CLI flags with usage help ([#1635](https://github.com/greyson3hardy/PATH/issues/1635)) ([06fa92b](https://github.com/greyson3hardy/PATH/commit/06fa92b021d9b790df1eb28df160daf7501c1493))
* **scan-ats-full:** respect data/blacklist.md ([#1914](https://github.com/greyson3hardy/PATH/issues/1914)) ([6512870](https://github.com/greyson3hardy/PATH/commit/65128701a062d30c7754405c687eef4a710a49c8)), closes [#1911](https://github.com/greyson3hardy/PATH/issues/1911)
* **scan-ats-full:** wire content_filter into reverse scans ([#1848](https://github.com/greyson3hardy/PATH/issues/1848)) ([f710ce9](https://github.com/greyson3hardy/PATH/commit/f710ce992758cb6d3644565e818cb6920fdc1cb2))
* **scan:** hide unconfigured salary/content filter summaries ([#1947](https://github.com/greyson3hardy/PATH/issues/1947)) ([b5659a1](https://github.com/greyson3hardy/PATH/commit/b5659a1754c1f90c0e1eaadae3ec08fd8c54000a))
* **scan:** load .env credentials via optional dotenv import ([#1507](https://github.com/greyson3hardy/PATH/issues/1507)) ([5066b28](https://github.com/greyson3hardy/PATH/commit/5066b284400cbc51b246eeff64c42af9f34e5c43))
* **scan:** normalize cosmetic URL variants for dedup ([#2079](https://github.com/greyson3hardy/PATH/issues/2079)) ([9ba7f2e](https://github.com/greyson3hardy/PATH/commit/9ba7f2e0fce55ef6c5c63810162413edf185bee5))
* **scan:** quiet dotenv so --json stdout stays parseable ([#1907](https://github.com/greyson3hardy/PATH/issues/1907)) ([2e0b29e](https://github.com/greyson3hardy/PATH/commit/2e0b29ebd1a8a2e67c249c65aa132749c99098f9)), closes [#1906](https://github.com/greyson3hardy/PATH/issues/1906)
* **scan:** restore browser-like headers on Workday CXS requests ([#1813](https://github.com/greyson3hardy/PATH/issues/1813)) ([14022de](https://github.com/greyson3hardy/PATH/commit/14022de87cdfa858c137553e4cd1f8b61a02f755)), closes [#1811](https://github.com/greyson3hardy/PATH/issues/1811)
* **scan:** seed the company+role dedupe key from all three seen-sources ([#2080](https://github.com/greyson3hardy/PATH/issues/2080)) ([9c2b426](https://github.com/greyson3hardy/PATH/commit/9c2b426d7473b49c7f9562413f9c3c75b675a06e))
* serialize all tracker writers through the shared lock ([#1912](https://github.com/greyson3hardy/PATH/issues/1912)) ([a953da2](https://github.com/greyson3hardy/PATH/commit/a953da2ade0c2585c80832ef77d4fe718ef69afa))
* **set-status:** fail closed when a lone company row contradicts --role ([#2108](https://github.com/greyson3hardy/PATH/issues/2108)) ([c05ce51](https://github.com/greyson3hardy/PATH/commit/c05ce51566e4a377810119be6eb83d87db967a7a)), closes [#2009](https://github.com/greyson3hardy/PATH/issues/2009)
* **skill:** routing drift + discoverable metadata across the agent surface ([8ac6261](https://github.com/greyson3hardy/PATH/commit/8ac6261e6ce75700727bf830def1af2bc78b6249))
* **successfactors:** preserve brand path for multi-brand RMK tenants ([#2099](https://github.com/greyson3hardy/PATH/issues/2099)) ([b623271](https://github.com/greyson3hardy/PATH/commit/b62327145a789c966978f2e0a9ec03c1ca431af6)), closes [#2010](https://github.com/greyson3hardy/PATH/issues/2010)
* **templates:** allowlist the template format to prevent path traversal ([#1776](https://github.com/greyson3hardy/PATH/issues/1776)) ([54fc973](https://github.com/greyson3hardy/PATH/commit/54fc9733ba167228460cc1d6b346e61b030ab08b))
* **test:** hermetic env for spawned node:test suites; mark roadmap 0.x done ([9e4efd5](https://github.com/greyson3hardy/PATH/commit/9e4efd50cc8b46aa9bdbc24381476eb1b2d2e346))
* **test:** keep discovered suites from terminating the run mid-suite ([32dcee0](https://github.com/greyson3hardy/PATH/commit/32dcee07472795cc94258753411861ca0365e322))
* **test:** normalize CRLF at read time for doc assertions ([#1771](https://github.com/greyson3hardy/PATH/issues/1771)) ([#1772](https://github.com/greyson3hardy/PATH/issues/1772)) ([b7a1ea1](https://github.com/greyson3hardy/PATH/commit/b7a1ea12f3c079b17dee61d9f77f47c36b462ed8))
* **tests:** close CodeQL command-injection findings in the test harness ([9cd6dbc](https://github.com/greyson3hardy/PATH/commit/9cd6dbc0c0dc17361d0babdece2803979f183069))
* **tests:** skip web-reader tests when web/ is absent on core-only installs ([#1675](https://github.com/greyson3hardy/PATH/issues/1675)) ([32dde78](https://github.com/greyson3hardy/PATH/commit/32dde7849b117f2c7c37205327af313f31dc7a5c))
* **tracker:** detect and prevent duplicate tracker # numbers ([#1704](https://github.com/greyson3hardy/PATH/issues/1704)) ([d9cc272](https://github.com/greyson3hardy/PATH/commit/d9cc272c76f69cbf9708477dfadc813abc8d6e23))
* **tracker:** recognize the Hired canonical status in merge-tracker and stats ([#2050](https://github.com/greyson3hardy/PATH/issues/2050)) ([feabcb4](https://github.com/greyson3hardy/PATH/commit/feabcb45003875c6f0bbd1e3e88676a539744e8d))
...
* unify atomic report number allocation ([#1910](https://github.com/greyson3hardy/PATH/issues/1910)) ([3b265cb](https://github.com/greyson3hardy/PATH/commit/3b265cb765ed7f85aded5ef2daa30ffec0bf42f3)), closes [#1733](https://github.com/greyson3hardy/PATH/issues/1733) [#1801](https://github.com/greyson3hardy/PATH/issues/1801) [#1835](https://github.com/greyson3hardy/PATH/issues/1835) [#1895](https://github.com/greyson3hardy/PATH/issues/1895)
* **update-system:** add .claude/hooks/ to USER_PATHS ([#1676](https://github.com/greyson3hardy/PATH/issues/1676)) ([e9bacc4](https://github.com/greyson3hardy/PATH/commit/e9bacc484185f56cec210ea821bf1774e989acea))
* **update-system:** attribute the post-update manifesto link (utm_source=updater) ([a363ec4](https://github.com/greyson3hardy/PATH/commit/a363ec45ec2fd101d80ca9cf5ba2f882f65cb029))
* **update-system:** keep the updater self-loading to survive old→new re-exec ([#1706](https://github.com/greyson3hardy/PATH/issues/1706)) ([ce72879](https://github.com/greyson3hardy/PATH/commit/ce7287960b3d16224f8af17ea2f5a5e5e7590543))
* **update-system:** surface commit failures instead of silently swallowing them ([#1855](https://github.com/greyson3hardy/PATH/issues/1855)) ([2ad3453](https://github.com/greyson3hardy/PATH/commit/2ad3453980d49a44ce10470b21cd2434db9701fa)), closes [#1844](https://github.com/greyson3hardy/PATH/issues/1844)
* **update-system:** verify the target manifest materialized instead of reporting success ([#2111](https://github.com/greyson3hardy/PATH/issues/2111)) ([e1fd205](https://github.com/greyson3hardy/PATH/commit/e1fd205bd8916ccc0e1060017259405c63af9ad3)), closes [#1998](https://github.com/greyson3hardy/PATH/issues/1998)
* **update:** make updater timeout budgets configurable ([#1564](https://github.com/greyson3hardy/PATH/issues/1564)) ([525c9c0](https://github.com/greyson3hardy/PATH/commit/525c9c0cbc8b6ab5b23a0e612537c75cab83b114))
* **update:** preserve local CLAUDE.md additions during /career-ops update ([#1446](https://github.com/greyson3hardy/PATH/issues/1446)) ([e5f5d25](https://github.com/greyson3hardy/PATH/commit/e5f5d2517ef598350065af1d2475e08bb28c02da))
* **updater:** add .claude/settings.json to USER_PATHS ([#1471](https://github.com/greyson3hardy/PATH/issues/1471)) ([aa8000d](https://github.com/greyson3hardy/PATH/commit/aa8000d84c397145196f8f494beefe86777e1090)), closes [#1408](https://github.com/greyson3hardy/PATH/issues/1408)
* **update:** raise local git timeout default 30s -&gt; 120s for cloud-evicted trees ([a7b5dfd](https://github.com/greyson3hardy/PATH/commit/a7b5dfd8c8c42c00f73b1bfa1c51338880637bf8))
* **upskill:** correct inverted known-skill suppression in targeted mode ([#1851](https://github.com/greyson3hardy/PATH/issues/1851)) ([4d95d70](https://github.com/greyson3hardy/PATH/commit/4d95d70704762dabcc540fe1f0b93cc9a2d78c41))
* **upskill:** keep fetched JD text as a string in the targeted --url-text path ([#1917](https://github.com/greyson3hardy/PATH/issues/1917)) ([c7e9ff5](https://github.com/greyson3hardy/PATH/commit/c7e9ff5993026131c67fa69077f0b54c293bb059)), closes [#1894](https://github.com/greyson3hardy/PATH/issues/1894)
* use rune-based backspace in discard-reason input and fix newline in tailor log ([9a78e7c](https://github.com/greyson3hardy/PATH/commit/9a78e7c93eda40f717523bba45490122459e0339))
* **verify-cv-facts:** stop a bare '&lt;' from swallowing source evidence ([#1995](https://github.com/greyson3hardy/PATH/issues/1995)) ([050828b](https://github.com/greyson3hardy/PATH/commit/050828b339f27cc398bf335d6f1c2b8ff2712145))
